...
platform_enemy_images = { "walk_rt": enemy_walk,
                          "walk_lt": [flip_image(img) for img in enemy_walk],
                          "jump_rt": enemy_jump,
                          "jump_lt": flip_image(enemy_jump) }
...
class Level():
    ...
    def load_items(self):
        ...
        for element in self.map_data['items']:
            ...
            if (kind == "Gem2") or (kind == "Sword"):
                s = Gem2(x, y, item_images[kind])

            if kind == "Heart":
                s = Heart(x, y, item_images[kind])

            if kind == "Life":
                s = Life(x, y, item_images[kind])
...
class Game():
    ...
    def show_title_screen(self):
        ...
        screen.blit(Start_Char_img, (1100,816))
        screen.blit(Start_Sword_img, (480,852))
        screen.blit(Start_flag1_img, (105, 190))
        screen.blit(Start_flag2_img, (105, 120))
        screen.blit(Start_flag1_img, (870, 190))
        screen.blit(Start_flag3_img, (870, 120))
    ...
    def show_stats(self):
        ...
        if self.hero.max_hearts == 5:
            screen.blit(Open_heart_img, (45,50))
            screen.blit(Open_heart_img, (85,50))
            screen.blit(Open_heart_img, (125,50))
            screen.blit(Open_heart_img, (165,50))
            screen.blit(Open_heart_img, (205,50))
        elif self.hero.max_hearts == 6:
            screen.blit(Open_heart_img, (45,50))
            screen.blit(Open_heart_img, (85,50))
            screen.blit(Open_heart_img, (125,50))
            screen.blit(Open_heart_img, (165,50))
            screen.blit(Open_heart_img, (205,50))
            screen.blit(Open_heart_img, (245,50))
        if self.hero.hearts == 1:
            screen.blit(Heart_img, (45,50))
        elif self.hero.hearts == 2:
            screen.blit(Heart_img, (45,50))
            screen.blit(Heart_img, (85,50))
        elif self.hero.hearts == 3:
            screen.blit(Heart_img, (45,50))
            screen.blit(Heart_img, (85,50))
            screen.blit(Heart_img, (125,50))
        elif self.hero.hearts == 4:
            screen.blit(Heart_img, (45,50))
            screen.blit(Heart_img, (85,50))
            screen.blit(Heart_img, (125,50))
            screen.blit(Heart_img, (165,50))
        elif self.hero.hearts == 5:
            screen.blit(Heart_img, (45,50))
            screen.blit(Heart_img, (85,50))
            screen.blit(Heart_img, (125,50))
            screen.blit(Heart_img, (165,50))
            screen.blit(Heart_img, (205,50))
        elif self.hero.hearts == 6:
            screen.blit(Heart_img, (45,50))
            screen.blit(Heart_img, (85,50))
            screen.blit(Heart_img, (125,50))
            screen.blit(Heart_img, (165,50))
            screen.blit(Heart_img, (205,50))
            screen.blit(Heart_img, (245,50))
    ...
    def update(self):
        if self.stage == Game.PLAYING:
            ...
            if self.hero.reached_goal:
                ...
                win_snd.play()
                self.hero.score += (((self.hero.rect.y*(-1))+900))
                print((((self.hero.rect.y*(-1))+900)))
