...
class Game():
    ...
    def show_stats(self):
        ...
        if self.hero.max_hearts == 5:
            screen.blit(Open_heart_img, (50,50))
            screen.blit(Open_heart_img, (90,50))
            screen.blit(Open_heart_img, (130,50))
            screen.blit(Open_heart_img, (170,50))
            screen.blit(Open_heart_img, (210,50))
            ...
            screen.blit(Open_heart_img, (170,50))
            screen.blit(Open_heart_img, (210,50))
            screen.blit(Open_heart_img, (250,50))
        if self.hero.hearts == 1:
            screen.blit(Heart_img, (50,50))
        elif self.hero.hearts == 2:
            screen.blit(Heart_img, (50,50))
            screen.blit(Heart_img, (90,50))
        elif self.hero.hearts == 3:
            screen.blit(Heart_img, (50,50))
            screen.blit(Heart_img, (90,50))
            screen.blit(Heart_img, (130,50))
        elif self.hero.hearts == 4:
            screen.blit(Heart_img, (50,50))
            screen.blit(Heart_img, (90,50))
            screen.blit(Heart_img, (130,50))
            screen.blit(Heart_img, (170,50))
        elif self.hero.hearts == 5:
            screen.blit(Heart_img, (50,50))
            screen.blit(Heart_img, (90,50))
            screen.blit(Heart_img, (130,50))
            screen.blit(Heart_img, (170,50))
            screen.blit(Heart_img, (210,50))
